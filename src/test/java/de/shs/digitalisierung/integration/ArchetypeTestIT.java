package de.shs.digitalisierung.integration;
...
import static de.shs.digitalisierung.domain.book.ISBN13.createISBN;
import static org.junit.jupiter.api.Assertions.assertEquals;

class  ArchetypeTestIT
{
    ...
    {
        jexxaIntegrationTest = new JexxaIntegrationTest(ArchetypeTest.class);
    ...
    void testStartupApplication()
    {
        ...
        //Assert
        assertEquals(ArchetypeTest.class.getSimpleName(), result);
    }
